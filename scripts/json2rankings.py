# Filename: json2rankings.py
# Author: NTPA
# Date: 12-14-2022
# Description: Use json file(created by ../app/app.js) to create rankings summary. 
#               Wll use less disk space since intermediate csv file is not created, only final rankings file.
#               Use json2csv.py if you wish to have a CSV file for future separate operation
# 
#               Rankings summary is output to standard output
...
if (len(sys.argv) < 2): 
    print("Not enough program arguments. Did you provide input json file?")
    print("Usage: python json2rankings.py <json-file>")
    exit()
...
with open(inputfile, 'r', encoding="utf-8") as f:
    for i, v in enumerate(json.load(f)):
        players.append(Player(v['name'], v['position'], v['pointsTotal'], v['leagueTeam']))
