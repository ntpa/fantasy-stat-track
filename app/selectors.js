  ...
  const desiredWeek = 'a[href="/league/6255172/team/10?statCategory=stats&statSeason=2022&statType=seasonStats&week=15"]'
  ...
  const teamRank = 'ul.teamStats .first strong'

export { username, password, submit, season, myLeagues, rosterPage, links, desiredWeek, 
        teamName, playerNameAndInfo, playerTotalPoints, teamRecord, teamRank };
